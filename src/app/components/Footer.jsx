    ...
    <div className="grid  sm:grid-cols-2 gap-9  py-12  container">
      <div className=" flex flex-col gap-7">
        ...
        <p className="text-sm text-[#2D2D2D]">
          ...
          <br />
          more at AnimaApp.com This is a template Figma file, turned into <br />{" "}
      ...
      <div className=" text-[#2D2D2D] flex flex-col sm:justify-center ">
        <div className="flex flex-col gap-5">
          <input
            className=" appearance-none w-full py-2 px-3 bg-[#F3F3F3] text-[#2D2D2D]  focus:outline-none "
            id="name"
            type="text"
            placeholder="Name"
          />
          <input
            ...
            placeholder="Email"
          />
          <button className="w-[150px] sm:w-[200px] h-[40px] sm:h-[50px] font-[400] text-[10px] sm:text-[15px] text-white bg-[#2D2D2D]">
            submit
          </button>
        </div>
      </div>
